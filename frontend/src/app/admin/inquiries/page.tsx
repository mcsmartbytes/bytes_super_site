      ...
      <div className="mb-6 flex gap-2 bg-white p-2 rounded-lg border border-gray-200 inline-flex">
        <button
          ...
          className={`px-4 py-2 rounded-md font-medium transition ${
            filter === 'all' ? 'bg-orange-600 text-white' : 'text-gray-600 hover:bg-gray-100'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md font-medium transition ${
            filter === 'new' ? 'bg-orange-600 text-white' : 'text-gray-600 hover:bg-gray-100'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md font-medium transition ${
            filter === 'read' ? 'bg-orange-600 text-white' : 'text-gray-600 hover:bg-gray-100'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md font-medium transition ${
            filter === 'responded' ? 'bg-orange-600 text-white' : 'text-gray-600 hover:bg-gray-100'
          }`}
        >
            ...
            {filteredInquiries.map((inquiry) => (
              <div
                ...
                className={`bg-white rounded-lg p-4 border-2 cursor-pointer transition-all hover:shadow-md ${
                  selectedInquiry?.id === inquiry.id ? 'border-orange-600 shadow-md' : 'border-gray-200'
                }`}
              >
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <div className="border-t pt-6 space-y-3">
                  ...
                  <a
                    ...
                    className="block w-full text-center px-4 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition font-semibold"
                  >
